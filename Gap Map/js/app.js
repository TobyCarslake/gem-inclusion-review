...
// const test = d3.selectAll("#grid .square");
// console.log(test);

// d3.select(this).selectAll('div > path');
// console.log(this);

// const test = d3.select('#map').selectAll('div > path');
// console.log(d3.select('#content g.map').selectAll('path'));
// console.log(d3.select('#grid').selectAll('.square'));

// var container = d3.select("body").selectAll("div.path"); 

// // now add it if it doesn't exist
// container.enter().append('div').attr('class', 'land');
